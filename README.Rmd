...
The sensitivity parameters may also be of interest. These can be extracted with
the code:
...
```
The output is the sensitivity parameters and an indicator if the treatment was
...
## Data example
For the purpose of illustration of the bounds we construct the simulated dataset
zika_learner. The zika example is based on studies of a zika outbreak in Brazil. 
See references in corresponding article and the data documentation.
...
```
Note that the eventual recoding of the treatment has to be done manually,
as discussed in the corresponding article.
