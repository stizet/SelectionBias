...
```
The output is the SV bound and the sensitivity parameters and an indicator if
the treatment was recoded if the bias in the original coding was negative.
