calcSVbound <- function(Y1,Y0,Tr,S,U,V,estimand,obsProb)
{
  ...
  # Calculate the probabilities P(U=u|T=t,I_S=s). Parts of these are needed for both populations.
  ...
  if(estimand=="RD_s"|estimand=="RR_s") # The subpopulation.
  {
    ...
    # The return vector.
    if(estimand=="RD_s"){returnVec = c(boundRD_s,BF_U,RR_TU_S1,RR_UY_S1,pY_T1,pY_T0)}else{returnVec = c(boundRR_s,BF_U,RR_TU_S1,RR_UY_S1)}
    ...
    # The return vector.
    if(estimand=="RD_tot"){returnVec = c(boundRD_tot,BF1,BF0,RR_SU_T1,RR_SU_T0,RR_UY_T1,RR_UY_T0,pY_T1,pY_T0)}else{returnVec = c(boundRR_tot,BF1,BF0,RR_SU_T1,RR_SU_T0,RR_UY_T1,RR_UY_T0)}
  }
