...
#' @param SVbound Optional input scalar. The SV bound (calculated in another
#'   place). Only necessary if one wants to know if the SV bound is not sharp.
#' @param AFbound Optional input scalar. The AF bound (calculated in another
#'   place). Only necessary if one wants to know if the SV bound is not sharp.
#'
