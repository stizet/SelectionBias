#' Calculate the Smith and VanderWeele bound for user specified sensitivity
#' parameters
#'
#' `SVbound()` returns a list with the SV bound. The eventual recoding of the
#' treatment has to be done manually. The input values can be calculated for a
#' DGP in `SVboundparametersM()`.
#'
...
#' @examples
#'
#' SVbound(whichEst = "RR_tot", RR_UY_T1 = 2, RR_UY_T0 = 2, RR_SU_T1 = 1.7, RR_SU_T0 = 1.5)
#' SVbound(whichEst = "RD_tot", RR_UY_T1 = 2, RR_UY_T0 = 2, RR_SU_T1 = 1.7, RR_SU_T0 = 1.5, pY1_T1_S1 = 0.05, pY1_T0_S1 = 0.01)
#' SVbound(whichEst = "RR_s", RR_UY_S1 = 2, RR_TU_S1 = 2.3)
#' SVbound(whichEst = "RD_s", RR_UY_S1 = 2, RR_TU_S1 = 2.3, pY1_T1_S1 = 0.05, pY1_T0_S1 = 0.01)
#'
                     ...
                     pY1_T1_S1 = NULL, pY1_T0_S1 = NULL)
{
  ...
  }else
  {
    ...
    # Calculate BF_U. Used in both "RR_s" and "RD_s".
