...
test_that("SVboundparametersM throws an error if the estimand is not correctly specified.", {
  ...
  expect_error(SVboundparametersM(V, U, Tr, Y, matrix(c(1, 0.1, 0, 0.9), nrow = 2,
                                                      byrow = TRUE), "RR_t", "P"), 'The estimand must be')
...
test_that("SVboundparametersM throws an error if inputs are incorrect.", {
  ...
  expect_error(SVboundparametersM(matrix(c(1, 0.1, 0, 0.9), nrow = 1, byrow = TRUE),
                                  U, Tr, Y, S, "RR_tot", "P"),
               "The number of columns in Vval")
  expect_error(SVboundparametersM(V, matrix(c(1, 0.1, 0, 0.9), nrow = 1, byrow = TRUE),
                                  Tr, Y, S, "RR_tot", "P"),
...
test_that("SVboundparametersM throws an error if the probabilities in V and U are not correct.", {
  ...
  expect_error(SVboundparametersM(matrix(c(1, 0.2, 0, 0.9), nrow = 2, byrow = TRUE),
                                  U, Tr, Y, S, "RR_tot", "P"),
               "The probabilities of the categories of V")
  expect_error(SVboundparametersM(matrix(c(1, 0.05, 0, 0.9), nrow = 2, byrow = TRUE),
                                  U, Tr, Y, S, "RR_tot", "P"),
               "The probabilities of the categories of V")
  expect_error(SVboundparametersM(V, matrix(c(1, 0.2, 0, 0.9), nrow = 2, byrow = TRUE),
                                  Tr, Y, S, "RR_tot", "P"),
               "The probabilities of the categories of U")
  expect_error(SVboundparametersM(V, matrix(c(1, 0.05, 0, 0.9), nrow = 2, byrow = TRUE),
                                  Tr, Y, S, "RR_tot", "P"),
               "The probabilities of the categories of U")
  expect_error(SVboundparametersM(matrix(c(1, -0.05, 0, 1.05), nrow = 2, byrow = TRUE),
                                  U, Tr, Y, S, "RR_tot", "P"),
               "At least one of the categories of V")
  expect_error(SVboundparametersM(V, matrix(c(1, -0.05, 0, 1.05), nrow = 2, byrow = TRUE),
                                  Tr, Y, S, "RR_tot", "P"),
               "At least one of the categories of U")
  expect_error(SVboundparametersM(matrix(c(1, 0, 0, 1.0), nrow = 2, byrow = TRUE),
                                  U, Tr, Y, S, "RR_tot", "P"),
               "At least one of the categories of V")
  expect_error(SVboundparametersM(V, matrix(c(1, 0, 0, 1.0), nrow = 2, byrow = TRUE),
                                  Tr, Y, S, "RR_tot", "P"),
               "At least one of the categories of U")
