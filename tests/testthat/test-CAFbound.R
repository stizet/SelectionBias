...
test_that("Bounds are equal to specific values.", {
  ...
  expect_equal(as.numeric(CAFbound(whichEst = "RR_tot", M = 0.8, m = 0.2, outcome = c(0.5, 0.5),
  ...
  expect_equal(as.numeric(CAFbound(whichEst = "RD_tot", M = 0.8, m = 0.2, outcome = c(0.5, 0.5),
  ...
  expect_equal(as.numeric(CAFbound(whichEst = "RR_sub", M = 0.8, m = 0.2, outcome = c(0.5, 0.5),
  ...
  expect_equal(as.numeric(CAFbound(whichEst = "RD_sub", M = 0.8, m = 0.2, outcome = c(0.5, 0.5),
...
test_that("CAFbound throws an error if the estimand is not correctly specified.", {

  expect_error(CAFbound(whichEst = "RR_t", M = 0.8, m = 0.2, outcome = c(0.5, 0.5),
...
test_that("CAFbound throws an error if the input takes on incorrect values.", {
  ...
  expect_error(CAFbound(whichEst = "RR_sub", M = 0.8, m = -0.2,
                        outcome = c(0.5, 0.5), treatment = c(0.5, 0.5)),
               "M and m cannot be smaller")
  expect_error(CAFbound(whichEst = "RR_sub", M = 0.2, m = 0.8,
                        outcome = c(0.5, 0.5), treatment = c(0.5, 0.5)),
